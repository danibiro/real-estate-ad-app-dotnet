...
public class RealEstateAgentProfile : Profile
{
    public RealEstateAgentProfile()
    {
        CreateMap<RealEstateAgentCreationDto, RealEstateAgent>();
        CreateMap<RealEstateAgent, RealEstateAgentDetailsDto>();
    }
}
